...
GetWindowInputDtoValidator"
    ...
    use_case = get_window.GetWindowUseCase(presenter_mock, repository_mock, logger_mock)
    input_dto = GetWindowInputDto(window_id=fixture_window["window_id"])
    ...
    logger_mock.log_info.assert_called_once_with("Window get successfully")
